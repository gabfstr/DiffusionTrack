...
def main(args):
    ...
    print(cfg)
    logger = logging.getLogger("detectron2")
    if ("CrowdHuman_train" in cfg.DATASETS.TRAIN) or ("CrowdHuman" in cfg.DATASETS.TRAIN) or ("crowdhuman" in cfg.DATASETS.TRAIN):
            logger.info("Registering crowdhuman dataset")
            register_coco_instances("CrowdHuman_train", {}, "datasets/crowdhuman/annotations/crowdhuman_train.json",
                "datasets/crowdhuman/CrowdHuman_train/")
            register_coco_instances("CrowdHuman_val", {}, "datasets/crowdhuman/annotations/crowdhuman_val.json",
                "datasets/crowdhuman/CrowdHuman_val/")
            MetadataCatalog.get("CrowdHuman_train").thing_classes = ["person"]
            MetadataCatalog.get("CrowdHuman_val").thing_classes = ["person"]
