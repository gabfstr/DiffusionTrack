...
class FastReIDInterface:
    ...
    def inference(self, image, detections):
        ...
        #print("\W :",W)
        #print("3? : ",_)
        #print("Input size test jspquoi :",tuple(self.cfg.INPUT.SIZE_TEST[::-1]))
        ...
        for d in range(np.size(detections, 0)):
            ...
            #print("tlbr[0:4] : ",tlbr[0:4])
            patch = image[tlbr[1]:tlbr[3], tlbr[0]:tlbr[2], :]
            #print("\npatch shape before : ",patch.shape)
            # the model expects RGB inputs
            patch = patch[:, :, ::-1]
            #print("patch shape after : ",patch.shape)
